...
case $ARCHITECTURE in
  arm|arm64)
    ...
    ;;
  *)
    [ -e $DOWNLOADS/parkr.tar.gz ] || curl -ksLf --retry 3 -o $DOWNLOADS/parkr.tar.gz https://github.com/gobuffalo/packr/releases/download/v${PACKR_VERSION}/packr_${PACKR_VERSION}_linux_$ARCHITECTURE.tar.gz
